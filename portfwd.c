...
static int pfd_closing(Plug plug, const TCHAR *error_msg, int error_code,
		       int calling_back)
{
 ...
 */
const TCHAR *pfd_newconnect(Socket *s, char *hostname, int port,
 ...
 */
const TCHAR *pfd_addforward(char *desthost, int destport, char *srcaddr,
