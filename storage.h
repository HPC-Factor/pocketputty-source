...
void write_setting_wcs(void *handle, const TCHAR *key, const TCHAR *value);
void write_setting_i(void *handle, const TCHAR *key, int value);
void write_setting_filename(void *handle, const TCHAR *key, Filename value);
void write_setting_fontspec(void *handle, const TCHAR *key, FontSpec font);
...
wchar_t *read_setting_wcs(void *handle, const TCHAR *key, wchar_t *buffer, int buflen);
int read_setting_i(void *handle, const TCHAR *key, int defvalue);
int read_setting_filename(void *handle, const TCHAR *key, Filename *value);
int read_setting_fontspec(void *handle, const TCHAR *key, FontSpec *font);
