...
void logwevent(void *, const wchar_t *);
...
extern const TCHAR *pfd_newconnect(Socket * s, char *hostname, int port,
				  void *c, const Config *cfg);
/* desthost == NULL indicates dynamic (SOCKS) port forwarding */
extern const TCHAR *pfd_addforward(char *desthost, int destport, char *srcaddr,
...
extern const TCHAR *x11_init(Socket *, char *, void *, void *, const char *,
			    int, const Config *);
...
#ifdef DEBUG
void diagbn(TCHAR *prefix, Bignum md);
#endif
