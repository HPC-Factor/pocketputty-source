...
#define _TATOFFSET(data, offset) ( (void *) ( (TCHAR *)(data) + (offset) ) ) // Aleq
...
#define NO_SHORTCUT MAKEWORD('\0', 0)
...
union control {
    ...
    struct {
	STANDARD_PREFIX;
	TCHAR shortcut;		       /* keyboard shortcut */
	/*
 ...
 */
struct controlset {
    TCHAR *pathname;		       /* panel path, e.g. "SSH/Tunnels" */
    TCHAR *boxname;		       /* internal short name of controlset */
    TCHAR *boxtitle;		       /* title of container box */
...
union control *ctrl_editbox(struct controlset *, TCHAR *label, TCHAR shortcut,
			    int percentage, intorptr helpctx,
			    handler_fn handler,
			    intorptr context, intorptr context2);
union control *ctrl_combobox(struct controlset *, TCHAR *label, TCHAR shortcut,
			     int percentage, intorptr helpctx,
			     handler_fn handler,
			     intorptr context, intorptr context2);
/*
 ...
 * is NO_SHORTCUT.
 */
union control *ctrl_radiobuttons(struct controlset *, TCHAR *label,
				 TCHAR shortcut, int ncolumns,
				 intorptr helpctx,
				 handler_fn handler, intorptr context, ...);
union control *ctrl_pushbutton(struct controlset *,TCHAR *label,TCHAR shortcut,
			       intorptr helpctx,
			       handler_fn handler, intorptr context);
union control *ctrl_listbox(struct controlset *,TCHAR *label,TCHAR shortcut,
			    intorptr helpctx,
			    handler_fn handler, intorptr context);
union control *ctrl_droplist(struct controlset *, TCHAR *label, TCHAR shortcut,
			     int percentage, intorptr helpctx,
			     handler_fn handler, intorptr context);
union control *ctrl_draglist(struct controlset *,TCHAR *label,TCHAR shortcut,
			     intorptr helpctx,
			     handler_fn handler, intorptr context);
union control *ctrl_filesel(struct controlset *,TCHAR *label,TCHAR shortcut,
			    TCHAR const *filter, int write, TCHAR *title,
			    intorptr helpctx,
			    handler_fn handler, intorptr context);
union control *ctrl_fontsel(struct controlset *,TCHAR *label,TCHAR shortcut,
			    intorptr helpctx,
			    handler_fn handler, intorptr context);
union control *ctrl_text(struct controlset *, TCHAR *text, intorptr helpctx);
union control *ctrl_checkbox(struct controlset *, TCHAR *label, TCHAR shortcut,
			     intorptr helpctx,
			     handler_fn handler, intorptr context);
